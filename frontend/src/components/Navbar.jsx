    ...
    <div className='container mx-auto px-4 py-3'>
        ...
        <nav className="flex flex-wrap items-center gap-4">
            ...
            <Link to={"/cart"} className='relative group text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out'>
                ...
                <span className='absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-1 py-1
        ...
        { user ? (
            ...
            <>
                <Link to={"/signup"} className='bg-emerald-700 hover:bg-emerald-600 text-white px-4 rounded-md flex items-center
                 transition duration-300 ease-in-out'>
                    <UserPlus className='inline-block mr-1' size={18} />
                    <span className='hidden sm:inline'>Sign Up</span>
                </Link>

                <Link to={"/login"} className='bg-gray-700 hover:bg-gray-600 text-white py-4 px-4 rounded-md flex items-center
                 transition duration-300 ease-in-out'>
